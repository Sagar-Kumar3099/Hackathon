  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #064E3B 0%, #059669 50%, #022C22 100%)",
      ...
      >
        ...
        >
          ...
          >
            Connect post-consumer garments, commercial textile scrap, and
            municipal drop points to optimal fiber recyclers using MongoDB
            persistence and OpenStreetMap 3D navigation.
          </p>

          <div
            className="grid-2 auth-stats"
        ...
        >
          <div>
            ...
            <p className="caption" style={{ marginTop: "4px" }}>
              {isSignup
                ? "Register your organization to access MongoDB route optimization."
                : "Sign in to access your circular textile dashboard and MongoDB orders."}
            </p>
          </div>
          ...
          {statusMessage && (
            <div
              style={{
                ...
                fontSize: "var(--font-size-xs)",
                background:
                  statusMessage.type === "success" ? "#D1FAE5" : "#FEE2E2",
              ...
              <div className="form-group">
                ...
                >
                  <option value="partner">
                    Industrial Supplier / Brand Partner
                  </option>
          ...
          >
            {isSignup
              ...
              : "Don't have an account in MongoDB?"}{" "}
            <button
              type="button"
              onClick={() => {
